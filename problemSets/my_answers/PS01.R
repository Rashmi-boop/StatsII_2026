...
# The coefficient estimated using the BFGS quasi-Newton method is numerically identical to 
# the coefficient estimated using lm(). This confirms that OLS estimation can be obtained by 
# minimizing the sum of squared residuals using numerical optimization. Because the OLS 
# objective function is quadratic and convex, the BFGS algorithm converges to the same global 
# minimum as the closed-form OLS estimator.